...
$Definition['%1$s joined.'] = '%1$s加入了酷盘论坛';
...
$Definition['EmailInvitation'] = '电子邮件邀请函!

%1$s hat dich eingeladen %2$s beizutreten. Wenn du dies machen möchtest, kannst du einfach folgenden Link anklicken::

  %3$s

Machs gut!';
$Definition['EmailMembershipApproved'] = '电子邮件会员批准

Du wurdest als Mitglied bestätigt. Logge dich über folgenden Link ein:

  %2$s
  
Machs gut!';
$Definition['EmailWelcome'] = '邮件欢迎%1$s,

%2$s hat einen Account für dich auf %3$s erstellt. Deine Anmeldedaten sind:
...
Machs gut!';
$Definition['EmailPassword'] = '邮箱密码%1$s,

%2$s hat dein Passwort auf %3$s zurückgesetzt. Deine Anmeldedaten sind nun:
...
Machs gut!';
$Definition['PasswordRequest'] = '密码请求%1$s,

Jemand hat die Zurücksetzung deines Passworts auf %2$s beantragt. Um das Passwort zurückzusetzen, klicke folgenden Link:

  %3$s

Wenn du die Änderung deines Passworts nicht beantragt hast, ignoriere diese E-Mail einfach.';
$Definition['EmailNotification'] = '邮件提醒

Klicke folgenden Link um die Details abzurufen:
%2$s

Machs gut!';
$Definition['EmailStoryNotification'] = '邮件通知事件
...
Machs gut!';
$Definition['PluginHelp'] = "插件帮助Plugins erlauben dir die Funktionalität deines Forums zu erweitern.<br />Lade Plugins in diesen Ordner %s folder und du kannst sie an dieser Stelle aktivieren und deaktivieren.";
$Definition['ApplicationHelp'] = "应用帮助。 您可以添加更多应用功能。<br />应用功能被加入到文件夹 %s,您可以在这里激活或关闭它"; 
$Definition['ThemeHelp'] = "主题帮助Themes erlauben dir das Aussehen deiner Seite zu verändern.<br />Lade Themes in diesen Ordner %s und du kannst diese hier aktivieren.";
