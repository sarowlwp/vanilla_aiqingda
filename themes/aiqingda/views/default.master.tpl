...
<body id="{$BodyID}" class="{$BodyClass}">
  <div id="Frame">
	 <div class="Banner">
	     <div class="BannerCenter">
			<span><a href="{link path="/"}">{logo}</a></span>
			<span class="BannerMenu">
				<ul>
				  <li><a href="/discussions">首页</a></li>
				  <li><a href="/categories/discussions">爱青大讨论区</a></li>
				  {activity_link}
				  <li><a href="/post/discussion">我要发帖</a></li>
				  {dashboard_link}
				  <!--{discussions_link}-->
				  {inbox_link}
				  {profile_link}
				  {custom_menu}
				  {signinout_link}
				  <!--<li><a class="faqs" href="/faqs">帮助 - FAQ</a></li>-->
				  <!--<li><div id="cse-search-form" class="GoogleSearchBox">Loading</div></li>-->
				</ul>
			</span>
			<span class="SiteSearch">{searchbox}</span>
		</div>
  ...
  <div id="returntotop" style="position: fixed;_position: absolute;z-index: 2;width: 50px;height: 50px;right: 50px;bottom: 50px;_top: expression(documentElement.scrollTop + documentElement.clientHeight - 76 + 'px');"> 
   <a><img src="/themes/aiqingda/design/images/arrow_up.png" border=0 alt="返回顶部"></a> 
  </div> 
</html>
